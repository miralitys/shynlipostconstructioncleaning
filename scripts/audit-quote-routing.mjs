...
writeFileSync(new URL('shynli-post-construction-quote-routing-2026-05-10.json', reportDir), JSON.stringify(report, null, 2))
...
console.log('Report: screenshots/shynli-post-construction-quote-routing-2026-05-10.json')
